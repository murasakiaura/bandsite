...
function createShowsCard(show) {
  ...
  dateHeading.innerText = show.dateheading;
  ...
  venueHeading.innerText = show.venueheading;
  ...
  locationHeading.innerText = show.locationheading;
